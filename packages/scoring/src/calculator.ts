...
import { MINIMUM_QUALITY_SCORE, MINIMUM_IMPACT_SCORE } from "@uxmind/types";
import { getRubric, getImpactRubric } from "./rubrics";
...
export function calculateImpactScore(scores: ScoreInput[]): ScoreResult {
  ...
  return {
    breakdown: { criteria, weighted_total: rounded_total },
    passed: rounded_total >= MINIMUM_IMPACT_SCORE,
  };
}
